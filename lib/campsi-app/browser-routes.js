...
module.exports = function (router, context) {
    ...
    var loadProjectDeployments = function (ctx, next) {
        context.projectDeployments(ctx.params.project, false, function (projectDeployments) {
            ctx.project.deployments = projectDeployments.deployments;
            next();
        });
    };
    ...
    router(routes.welcome.path, loadProjects, updateLinks, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
            layout(routes.welcome.layout);
        });
    });

    router(routes.projects.path, loadProjects, updateLinks, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
            layout(routes.projects.layout);
        });
    });

    router(routes.newProject.path, loadProjects, updateLinks, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
    ...
    router(routes.project.path, loadProjects, loadProject, updateLinks, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
    ...
    router(routes.projectUsers.path, loadProject, loadProjectUsers, updateLinks, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.projectDeployments.path, loadProject, loadProjectDeployments, updateLinks, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.newCollection.path, loadProject, updateLinks, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.collection.path, loadProject, loadCollection, updateLinks, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.entries.path, loadProject, loadCollection, loadEntriesAndDrafts, updateLinks, hideLoading, function (ctx) {
    ...
    router(routes.designer.path, loadProject, loadCollection, loadComponents, updateLinks, hideLoading, function (ctx) {
    ...
    router(routes.entry.path, loadProject, loadCollection, loadEntriesAndDrafts, loadEntry, updateLinks, hideLoading, function (ctx) {
        panels.entries.setValue(ctx.entriesAndDrafts, function () {
            panels.entryOptions(ctx.collection, function () {
    ...
    router(routes.draft.path, loadProject, loadCollection, loadEntriesAndDrafts, loadDraft, updateLinks, hideLoading, function (ctx) {
        panels.entries.setValue(ctx.entriesAndDrafts, function () {
            panels.entry.component.setOptions(ctx.collection, function () {
