...
module.exports = function (router, context) {
    ...
    router('/*', showLoading, updateLinks);

    router(routes.welcome.path, loadProjects, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
            layout(routes.welcome.layout);
        });
    });

    router(routes.projects.path, loadProjects, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
            layout(routes.projects.layout);
        });
    });

    router(routes.newProject.path, loadProjects, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
    ...
    router(routes.project.path, loadProjects, loadProject, hideLoading, function (ctx) {
        panels.projects.setValue(ctx.projects, function () {
    ...
    router(routes.projectUsers.path, loadProject, loadProjectUsers, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.projectDeployments.path, loadProject, loadProjectDeployments, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.newCollection.path, loadProject, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.collection.path, loadProject, loadCollection, hideLoading, function (ctx) {
        panels.project.setValue(ctx.project, function () {
    ...
    router(routes.entries.path, loadProject, loadCollection, loadEntriesAndDrafts, hideLoading, function (ctx) {
    ...
    router(routes.designer.path, loadProject, loadCollection, loadComponents, hideLoading, function (ctx) {
    ...
    router(routes.entry.path, loadProject, loadCollection, loadEntriesAndDrafts, loadEntry, hideLoading, function (ctx) {
        panels.entries.setValue(ctx.entriesAndDrafts, function () {
            panels.entry.component.setOptions(ctx.collection, function () {
    ...
    router(routes.draft.path, loadProject, loadCollection, loadEntriesAndDrafts, loadDraft, hideLoading, function (ctx) {
        panels.entries.setValue(ctx.entriesAndDrafts, function () {
            panels.entry.component.setOptions(ctx.collection, function () {
