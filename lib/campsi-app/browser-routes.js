...
module.exports = function (router, context) {
    ...
    router(routes.projectUsers.path, routeMatch, load('project', 'projectUsers', 'templates'), function (ctx, next) {
    ...
    router(routes.newCollection.path, routeMatch, load('project', 'templates'), function (ctx, next) {
    ...
    router(routes.collectionFieldProperties.path, routeMatch, load('project', 'collection', 'templates', 'components'), function (ctx, next) {
    ...
    router('*', breakIfRouteDidNotMatch, updateLinks, hideLoading, sendPageView, execLayout);
