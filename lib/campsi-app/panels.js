...
module.exports = {
    ...
    project: {
        ...
        leftButtons: [{tag: 'a', attr: {class: 'close', href: routes.projects.path}, content: 'close', icon: 'times'}],
        rightButtons: [
    ...
    collection: {
        ...
        leftButtons: [{tag: 'a', attr: {class: 'close', href: routes.project.path}, content: 'close', icon: 'times'}],
        rightButtons: [
            {tag: 'button', attr: {class: 'delete'}, content: 'delete', icon:'trash-o'},
            deepcopy(saveBtn),
    ...
    designer: {
        ...
        rightButtons: [{tag: 'a', attr: {class: 'back', href: routes.entries.path}, content: 'admin', icon: 'pencil'}, saveBtn]
    },
    components: {
        title: 'Components',
        id: 'components',
    ...
    entry: {
        ...
        rightButtons: [
            deepcopy(saveBtn),
            {tag: 'button', attr: {class: 'remove'}, content: 'delete', icon: 'trash-o'},
