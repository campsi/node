...
module.exports = {
    ...
    project: {
        ...
        rightButtons: [
            ...
            {
                tag: 'a',
                attr: {class: 'upload', href: routes.projectDeployments.path},
                content: 'deployments',
                icon: 'cloud-upload'
            },
            deepcopy(saveBtn)
    ...
    designer: {
        ...
        leftButtons: [{
            tag: 'a',
            attr: {class: 'back', href: routes.collection.path},
            content: 'back',
            icon: 'angle-left'
        }],
        rightButtons: [{
            tag: 'a',
            attr: {class: 'admin', href: routes.entries.path},
            content: 'admin',
            icon: 'pencil'
        }, saveBtn]
    },
