...
var favoriteBtn = function (ctx) {
    return {
        ...
        icon: 'star',
        content: ctx.translate('btns.favorite')
    }
};
    ...
    return {
        ...
        dashboard: {
            ...
            rightButtons: [{
                ...
                content: ctx.translate('btns.projects'),
                icon: 'list'
            }]
        },
        projects: {
            ...
            leftButtons: [{
                tag: 'a',
                attr: {class: 'back', href: 'dashboard'},
            ...
            rightButtons: [
                {
                    tag: 'button',
                    attr: {class: 'delete'},
                    content: ctx.translate('btns.delete'),
                    icon: 'trash-o'
                },
                {
                    tag: 'a',
        ...
        fieldProperties: {
            ...
            leftButtons: [{
                tag: 'a',
                attr: {class: 'close', href: 'collection'},
                content: ctx.translate('btns.close'),
                icon: 'times'
            }],
            rightButtons: []
        },
