    ...
    return {
        ...
        attachEvents: function () {
            ...
            instance.form.bind('change', function () {
                ...
                instance.value = {
                    fieldName: instance.value.fieldName,
                    collection: {fields: instance.fields}
                };
        ...
        serializeValue: function () {
            if (this.value.fieldName && this.value.collection) {
                return {
                    ...
                    collection: {fields: this.value.collection.fields}
                };
            }
            return {};
        },
        save: function () {
            ...
            var collectionPanelComponent = this.context.panels.editCollection.component;
