...
module.exports = Campsi.extend('form', 'campsi/collection', function ($super) {
    ...
    return {
        ...
        attachEvents: function () {
            ...
            this.fields.fields.bind('editProperties', function (event) {
        ...
        save: function (data) {
            ...
            var safePayload = {};
            if(data.fields) safePayload.fields = data.fields;
            if(data.icon) safePayload.icon = data.icon;
            if(data.name) safePayload.name = data.name;
            if(data.identifier) safePayload.identifier = data.identifier;
