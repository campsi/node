        ...
        getFormOptions: function () {
            return {
                fields: [
                    {
                        name: 'name',
                        label: this.context.translate('panels.editCollection.fields.name.label'),
                        type: 'text',
                        required: true,
                        placeholder: this.context.translate('panels.editCollection.fields.name.placeholder'),
                        additionalClasses: ['title']
                    },
                    {
                        name: 'identifier',
                        type: 'text',
                        label: this.context.translate('panels.editCollection.fields.identifier'),
                    ...
                    },
                    {
                        ...
                        label: this.context.translate('panels.editCollection.fields.fields')
                    }
                ]
            };
        },
