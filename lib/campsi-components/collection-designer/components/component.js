...
module.exports = Campsi.extend('component', 'campsi/collection-designer/components', function ($super) {
    return {
        ...
        createComponent: function (component, $category) {
            var $component = $('<div class="component-icon draggable">' + '        <div class="icon drag-handle"></div>' + '        <span class="name"></span>' + '</div>');
        ...
        createCategory: function (category, components) {
            var $category = $('<div class="group">' + '     <h3></h3>' + '     <div class="components dragzone"></div>' + '</div>');
