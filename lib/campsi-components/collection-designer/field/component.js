    ...
    return {
        ...
        valueDidChange: function (next) {
            ...
            if (instance.value.type === instance.componentType) {
                ...
                instance.nodes.header.find('.type')
                    .empty()
                    .append($('<img>').attr('src', '/components/' + instance.componentType + '/icon.png'));
                ...
                Campsi.get(instance.value.type, function (Component) {
                    ...
                    //Component.prototype.designerFormDidChange(instance.componentOptionsForm, function(){
                    //
                    //});
