        ...
        init: function (next) {
            ...
            $super.init.call(instance, function () {
                instance.context.get('templates', {}, function (templates) {
                    instance.nodes.intro = $('<div class="intro">').html(instance.context.translate('panels.editProject.collections.wizard.intro'));
                    instance.nodes.templates = $('<div class="templates"></div>');
                    instance.nodes.templates.append(instance.createTemplate({
                        _id: 'empty',
                        identifier: 'empty',
                        name: instance.context.translate('panels.editProject.templates.empty'),
