    ...
    return {
        ...
        valueDidChange: function (next) {
            var templateVars = {
                ...
                entriesText: this.context.translate('panels.editProject.collectionList.entriesCount'),
                editStructureHref: this.context.applicationURL('editCollection', { collection: this.value }),
                editStructureText: this.context.translate('panels.editProject.collectionList.editBtn'),
                editEntriesHref: this.context.applicationURL('collection', { collection: this.value }),
                editEntriesText: this.context.translate('panels.editProject.collectionList.adminBtn')
            };
