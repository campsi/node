    ...
    return {
        ...
        getTemplate: function () {
            return '<div>' +
                ...
                '   <div class="entries"><span class="count">{{entriesCount}}</span>&nbsp;{{entriesText}}</div>' +
                '   <div class="actions">' +
                '       <a href="{{editStructureHref}}">' +
                '           <img src="https://campsi.imgix.net/56b0f1c85f9e20f80551b670-N1Iq0H41W.png">' +
                '           <span>{{editStructureText}}</span>' +
                '       </a>' +
                '       <a href="{{editEntriesHref}}">' +
                '           <img src="https://campsi.imgix.net/56b0f1c85f9e20f80551b670-NJgd1INJW.png">' +
                '           <span>{{editEntriesText}}</span>' +
                '       </a>' +
                '   </div>' +
                '</div>';
        },
