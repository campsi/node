    ...
    return {
        ...
        valueDidChange: function (next) {
            ...
            if (instance.value.users) {
                ...
                instance.context.get('projectUsers', function (users) {
                    ...
                    instance.context.get('projectGuests', function (guests) {
                        instance.value.users = users;
                        instance.value.guests = guests;
        ...
        sendInvitation: function () {
            ...
            $.ajax({
                ...
                instance.context.invalidate('project');
                instance.context.invalidate('projectUsers');
                instance.context.invalidate('projectGuests');
