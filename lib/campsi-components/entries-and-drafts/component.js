    ...
    return {
        ...
        attachEvents: function () {
            ...
            this.entries.bind('change', function () {
                instance.setValue({entries: instance.entries.value, drafts: instance.drafts.value});
            });
            ...
            $super.wakeUp.call(this, el, context, function () {
                Campsi.wakeUp(instance.nodes.drafts.find('> .component'), instance.context, function (comp) {
                    ...
                    Campsi.wakeUp(instance.nodes.entries.find('> .component'), instance.context, function (comp) {
                        ...
                        console.info('entries and drafts value after wakeup', instance.value);
                        next();
                    });
                });
            })
        ...
        valueDidChange: function (next) {
            ...
            console.info('entries and drafts new value', this.value, equals(this.getPreviousValue(), this.value));
