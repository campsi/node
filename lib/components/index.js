...
module.exports = {
    ...
    'blocks': require('./blocks/component'),
    'blocks/block': require('./blocks/block/component'),
    ...
    'date/datetime': require('./date/datetime/component'),
    'date/time': require('./date/time/component'),
