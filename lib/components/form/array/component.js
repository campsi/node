    ...
    return {
        ...
        init: function (next) {
            ...
            $super.init.call(this, function () {
                this.nodes.items = $('<div class="items"></div>');
            ...
            $super.wakeUp.call(instance, el, function () {
                async.forEachOf(instance.nodes.items.find('> .form_array_item'), function (itemEl, index, cb) {
                    Campsi.wakeUp(itemEl, function (itemComponent) {
                        ...
                        instance.value[index] = itemComponent.options;
                        cb.call(null);
                    })
                }, function () {
                    Campsi.wakeUp(instance.nodes.newItemForm.find('> .component'), function (newItem) {
        ...
        attachEvents: function () {
            ...
            this.nodes.newItemForm.on('submit', function (event) {
                try {
                    ...
                    instance.newItem.setValue(null);
                } catch (err) {
                    console.error(err);
                }
        ...
        createItemAt: function (newItem, index) {
            var instance = this;
