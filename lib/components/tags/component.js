    ...
    return {
        ...
        attachEvents: function () {
            ...
            instance.textComponent.bind('submit', function () {
                if (Array.isArray(instance.value) && instance.value.indexOf(instance.textComponent.value) !== -1) {
                    return;
                }
                var newValue = Array.isArray(instance.value) ? deepCopy(instance.value) : [];
