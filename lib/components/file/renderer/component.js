...
module.exports = Campsi.extend('component', 'file/renderer', function ($super) {
    ...
    return {
        ...
        createIcon: function () {
            return '<svg width="100%" height="100%" viewBox="0 0 49 64"><g>' +
                '<path class="file" d="M49,16.8v42.1c0,2.8-2.3,5.1-5.1,5.1H5.1C2.3,64,0,61.7,0,58.9V5.1C0,2.3,2.3,0,5.1,0h27L49,16.8z"/>' +
                '<path class="corner" d="M49,15.9V18H35.2c-2.9,0-4.2-2.3-4.2-5.2V0h2.1L49,15.9z"/>' +
                '</g></svg>';
        },
