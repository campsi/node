...
module.exports = Campsi.extend('component', 'array/item', function ($super) {
    return {
        ...
        optionsDidChange: function (next) {
            var instance = this;
            if (instance.options.removeButton === false) {
                instance.nodes.removeButton.hide();
            }

            if (instance.options.itemsAdditionalClasses) {
                var additionalClasses = Array.isArray(instance.options.itemsAdditionalClasses) ? instance.options.itemsAdditionalClasses.join(' ') : instance.options.itemsAdditionalClasses.toString();
                instance.mountNode.addClass(additionalClasses);
            }
