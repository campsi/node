    ...
    return {
        ...
        init: function (next) {
            ...
            $super.init.call(this, function () {
                Campsi.create('campsi/entry-list', {context: instance.context}, function (comp) {
        ...
        wakeUp: function (el,context, next) {
            ...
            $super.wakeUp.call(this, el, context,function () {
                Campsi.wakeUp(instance.mountNode.find('.component')[0], context, function (comp) {
                    instance.entryList = comp;
        ...
        attachEvents: function () {
            ...
            this.entryList.bind('change', function () {
                instance.setValue(instance.entryList.value);
            });
        },
        ...
        save: function () {
            ...
            var instance = this;
            var url = instance.context.apiURL('collection');
            var method = 'PUT';
            var data = {entries: this.entryList.value};
            $.ajax({
                url: url,
                method: method,
                dataType: 'json',
