...
module.exports = Campsi.extend('component', 'campsi/entry-list/entry', function ($super) {
    ...
    return {
        ...
        valueDidChange: function (next) {
            ...
            var resourceType = (this.value.draft === true) ? 'drafts' : 'entries';

            this.mountNode.attr('href', this.value.__collectionUrl + '/' + resourceType + '/' + this.value._id);
            this.mountNode.toggleClass('draft', this.value.draft === true);
