        ...
        init: function (next) {
            ...
            $super.init.call(this, function () {
                ...
                async.parallel([
                    ...
                    instance.mountNode.append('<div class="confirmation pane"><p><i class="fa fa-5x fa-check-circle"></i> Invitation sent!</p></div>');
                    instance.mountNode.append('<div class="error pane"><p><i class="fa fa-5x fa-minus-circle"></i> An error occured. Wrong email ?</p></div>');
                    next();
                });
