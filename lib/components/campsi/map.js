require('./billing/component');
require('./collection/component');
require('./collection/api-doc/component');
require('./collection/field-properties/component');
require('./collection/intro/component');
...
require('./dashboard/widget/component');
require('./dashboard/widget/activity/component');
require('./dashboard/widget/favorites/component');
require('./dashboard/widget/news/component');
require('./dashboard/widget/profile/component');
...
require('./project/intro/component');
