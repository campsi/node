    ...
    return {
        ...
        init: function (next) {
            ...
            $super.init.call(this, function () {
                Campsi.create('form', {
                    ...
                    $advancedOptionsFormPanel.append($('<div class="wrapper">').append(instance.advancedOptionsForm.render()));
        ...
        wakeUp: function (el, context, next) {
            ...
            $super.wakeUp.call(instance, el, context, function () {
                var advancedFormEl = instance.nodes.advancedFormPanel.find('> .wrapper > .form');
        ...
        attachEvents: function () {
            ...
            this.fields.fields.bind('editAdvancedOptions', function (field) {
                Campsi.create(field.componentType, {context: instance.context}, function (virtualComponentInstance) {
                    var formFieldOptions = instance.getDefaultAdvancedFormFields();
                    var options = virtualComponentInstance.getAdvancedFormOptions();
                    var fields = formFieldOptions.concat(options.fields);

                    // Ajout du champ "valeur par défaut" => plante avec les arrays
                    //fields.push(extend(deepCopy(field.value), {
                    //    name: 'defaultValue',
