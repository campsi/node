    ...
    return {
        ...
        attachEvents: function () {
            ...
            instance.form.bind('change', function () {
                console.info('properties form changed');
            });
        },
        ...
        valueDidChange: function (next) {
            ...
            if (instance.value.fieldName) {
                ...
                var ref = instance.value.collection.fields;
                var i = 0;
                var j;
                for (; i < path.length; i++) {
                    if(ref.type === 'form'){
                ...
                Campsi.create(ref.type, {context: instance.context}, function(dummyComponent){
                    ...
                    instance.form.setOptions({fields: propertiesFields}, function(){
                        instance.form.setValue(ref, function(){
                            next();
                        }, false)
                    });
                });
