...
Campsi.extend('form/field', 'campsi/component-chooser', function ($super) {
    ...
    return {
        ...
        init: function (next) {
            ...
            $super.init.call(instance, function () {
                ...
                instance.nodes.control.append(instance.nodes.dropzone);
                next.call(instance);
            });
        },
        ...
        getComponent: function (callback) {
            ...
            if (typeof instance.component === 'undefined') {
                Campsi.create('campsi/collection-designer/field', undefined, undefined, function (comp) {
