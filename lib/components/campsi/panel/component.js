    ...
    return {
        ...
        optionsDidChange: function (next) {
            ...
            if (typeof instance.options.component === 'undefined') {
                ...
                //if (isBrowser) {
                //
                //    $.getJSON('/api/v1/projects/campsi/collections/landing-pages/entries/' + instance.options.view, function (entry) {
                //        $(instance.nodes.content).append(entry.data.body);
                //        next();
                //    });
                //
                //} else {
                //    var Entry = require('../../../../models/entry');
                //    Entry.findOne({_id: instance.options.view}, function (err, entry) {
                //        $(instance.nodes.content).append(entry.toObject().data.body);
                //        next();
                //    });
                //}
                next();
