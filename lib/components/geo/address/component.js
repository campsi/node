...
module.exports = Campsi.extend('form', 'geo/address', function () {
    return {
                ...
                fields: [
                    {
                        type: 'text',
                        name: 'line1',
                        label: t('address.line1')    //additionalClasses: ['horizontal']
                    },
                    {
                        type: 'text',
                        name: 'line2',
                        label: t('address.line2')    //additionalClasses: ['horizontal']
                    },
                    {
                        type: 'text',
                        name: 'line3',
                        label: t('address.line3')    //additionalClasses: ['horizontal']
                    },
                    {
                        type: 'text',
                        name: 'postalCode',
