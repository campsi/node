...
module.exports = (function () {
    ...
    var createV2 = function (name, settings, callback) {
        ...
        get(name, function (Component) {
            ...
            if(name === 'campsi/collection-designer/components'){
                console.dir(settings);
            }

            c.value = settings.value || c.getDefaultValue();
            ...
            if(name === 'campsi/collection-designer/components'){
                console.dir(settings);
                console.dir(c.getDefaultValue());
                console.dir(c.value);
            }


            c.init(function () {
                c.optionsDidChange(function () {
                    c.valueDidChange(function () {
                        callback.call(c, c);
                    });
                });
            });
