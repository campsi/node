...
Context.prototype = Object.create(extend(load, {
    ...
    projectDeployments: function (id, reload, cb) {
        if (id || reload) {
            return this._load(reload, 'projectDeployments', this._getProjectUrl(id) + '/deployments', cb);
        }
        return cb(this._projectDeployments);
    },
    ...
    entriesAndDrafts: function (reload, cb) {
        if (reload || typeof this._entriesAndDrafts === 'undefined') {
